...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <!--Content right-->
            <div class="col content pt-3 pl-0">                
                <!--Dashboard widget-->
                            ...
                            <div class="bg-white border shadow">
                                <div class="media p-4">
                                    ...
                                    <div class="media-body pl-2">
                                        <h3 class="mt-0 mb-0"><strong>3,134,000</strong></h3>
                                        <p><small class="text-muted bc-description">National Beneficiaries</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                            <div class="bg-white border shadow">
                                <div class="media p-4">
                                    ...
                                    <div class="media-body pl-2">
                                        <h3 class="mt-0 mb-0"><strong>4</strong></h3>
                                        <p><small class="text-muted bc-description">Programmes</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                            <div class="bg-theme border shadow">
                                <div class="media p-4">
                                    ...
                                    <div class="media-body pl-2">
                                        <h3 class="mt-0 mb-0"><strong>22</strong></h3>
                                        <p><small class="bc-description text-white">Interventions</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
